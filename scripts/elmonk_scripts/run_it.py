...
BASEDIR = '/home/rusack/shared/ECAL_laser_data/' 
...
dst_dfs, xtals = dfb.pullSlimAndSkim(BASEDIR+'ECAL_RADDAM_Data/'+year+'/dst.w447.hdf5',
                                     BASEDIR+'ECAL_RADDAM_Data/'+year+'/oms.hdf5', 
                                     out_file=None, 
                                     slim=False, 
                                     max_xtals=max_xtals,
...
lumi_df = dfb.load_year(yr,BASEDIR+'Lumi_Data/'+year+'/') 
...
for xtal, dst_df in zip(xtals, dst_dfs):
    ...
    iov_df = dfb.pullIOVtoDF(BASEDIR+'ECAL_RADDAM_Data/'+year+'/iov.w447.hdf5', ['p1','p2','p3'], xtal)
    #lumi_df.to_csv('../dataframes/lumi_xtal_{}_{}.csv'.format(xtal, year))
    #iov_df.to_csv('../dataframes/iov_xtal_{}_{}.csv'.format(xtal, year))
    #dst_df.to_csv('../dataframes/dst_xtal_{}_{}.csv'.format(xtal, year))
    print('Stitching...')
